...
for alg in algs
    ...
    # Compare at matching time points (GPU tstop handling may save fewer points)
    ...
    local sol = solve(
        ...
        tstops = [2.4f0, 4.0f0], saveat = [0.0f0, 4.0f0]
    )
    ...
    @test norm(asol.u[1](2.4f0) - sol.u[1](2.4f0)) < 3.0e-3
    @test norm(asol.u[1](4.0f0) - sol.u[1](4.0f0)) < 5.0e-3
