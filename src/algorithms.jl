...
# Arguments
  ...
  - `cpu_offload`: the fraction of trajectories to offload to CPU execution. The two-argument
    constructor stores this value as a `Float64`; the one-argument constructor defaults to
    `0.2`.
